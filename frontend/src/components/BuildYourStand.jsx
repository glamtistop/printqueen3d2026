      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div id="step-base" className="glass-card rounded-2xl overflow-hidden scroll-mt-24">
            ...
            <div 
              className={`overflow-hidden transition-all duration-500 ease-in-out ${
                expandedSections.base ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'
              }`}
            >
            ...
            >
              <div className="flex items-center space-x-4">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold transition-all duration-300 ${
                  ...
                  {primaryColor && secondaryColor ? <Check className="h-6 w-6 animate-in zoom-in duration-300" /> : '2'}
                </div>
                <div>
            ...
            >
              <div className="flex items-center space-x-4">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold transition-all duration-300 ${
                  ...
                  {logoFile ? <Check className="h-6 w-6 animate-in zoom-in duration-300" /> : '3'}
                </div>
                <div>
          ...
          <div id="step-links" className="glass-card rounded-2xl overflow-hidden scroll-mt-24">
            ...
            <div 
              className={`overflow-hidden transition-all duration-500 ease-in-out ${
                expandedSections.links ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'
              }`}
            >
              <div className="p-6">
            ...
            >
              <div className="flex items-center space-x-4">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold transition-all duration-300 ${
                  ...
                  {hasIcons ? <Check className="h-6 w-6 animate-in zoom-in duration-300" /> : '5'}
                </div>
                <div>
